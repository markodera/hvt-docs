  ...
  return (
    ...
    >
      ...
      <DocSection id="runtime-auth" title="2. App user sign-up and sign-in">
        <p>
          Runtime auth is for the users of your app. Your app presents a project-scoped API key with <strong>auth:runtime</strong>, then calls <strong>client.auth.register</strong> and <strong>client.auth.runtimeLogin</strong>.
        </p>
